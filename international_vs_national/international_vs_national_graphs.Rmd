...
figure_1a <- ggplot(ghana_spike, aes(x = date, y = true_article_total)) +
  geom_line(stat = "identity", color = "blue") +
  labs(x = "Date", y = "Article Totals", title = "Figure 1a: Ghana - True Spike") +
  theme_bw()
...
figure_1b <- ggplot(zambia_old, aes(x = date, y = total)) +
  geom_line(stat = "identity", color = "red") +
  labs(x = "Date", y = "Article Totals", title = "Figure 1b: Zambia - False Spike") +
  theme_bw()
...
```{r}
# Combine the plots
figure_1 <- grid.arrange(figure_1a,
                      figure_1b,
                      nrow = 1,
                      top = textGrob("Figure 1: A True Spike and A False Spike",gp=gpar(fontsize=20,font=3)))

ggsave("figures/figure_1.jpg", plot = figure_1, height = 5, width = 7)
```

# Figure 6 - Indonesia Case Study
Figure 3 comes before Figure 2 because we will combine regional and international for figure 2
...
indonesia_corruption <- ggplot(indonesia, aes(x = date, y = corruption*10000, group = international, color = international)) +
  ...
  labs(title= "Corruption", y="Articles per 10,000", x = "", color = "legend") + 
  theme_bw() + 
...
indonesia_arrest <- ggplot(indonesia, aes(x = date, y = arrest*10000, group = international, color = international)) +
  scale_color_manual(name = "Source Type:", values = c("International" = "chartreuse4", "Local" = "blue", "Regional" = "darkred")) +
  geom_line(stat = "identity") +
  labs(title= "Arrest", y="Articles per 10,000", x = "", color = "legend") + 
...
indonesia_legalaction <- ggplot(indonesia, aes(x = date, y = legalaction*10000, group = international, color = international)) +
  scale_color_manual(name = "Source Type:", values = c("International" = "chartreuse4", "Local" = "blue", "Regional" = "darkred")) +
  geom_line(stat = "identity") +
  labs(title= "Legal Action", y="Articles per 10,000", x = "", color = "legend") + 
  theme_bw() + 
  theme(legend.position="none")
...
plot_indonesia <- grid.arrange(indonesia_corruption, indonesia_arrest, legend,
             ...
             top = textGrob("Figure 5: Indonesia 2024 Case Study",gp=gpar(fontsize=20,font=3)))

ggsave("figures/figure_6_indonesia.jpg", plot = plot_indonesia, height = 5, width = 7)
...
figure_3 <- ggplot(topic_share_long_stack, aes(x = c(variable))) + 
  ...
  labs(y="Share", x = "", color = "legend", title = "Figure 2: International Share of Normalized Articles \n With Correlations") + 
  scale_fill_manual(name = "Source Type:", values = colors) +
  theme_bw() +
  theme(axis.text.x = element_text(size=10, angle=90), legend.position="bottom", legend.title = element_text(size=10)) +
...
figure_4_alternative <- ggplot(event_share_long, aes(x = c(variable))) + 
  geom_bar(aes(y = international, group = 1, fill="International"), stat="identity", alpha = 0.5) +
  geom_bar(aes(y = local, group = 1, fill="National"), stat="identity", alpha = 0.2) +
  labs(y="Frequency", x = "", color = "legend", title = "Figure 3: Event Share of Total by \n International and National") + 
  scale_fill_manual(name = "Source Type:", values = colors) +
  theme_bw() +
  theme(axis.text.x = element_text(size=10, angle=90), legend.position="bottom", legend.title = element_text(size=10)) +
  geom_text(y= topic_share_long$local, aes(label = round(average_cor,2)), vjust = 1, colour = "darkgrey")
...
# New Figure 5 - Correlation vs Share International by Country
...
figure_5_alternative <- ggplot(country_int_count, aes(x = Log_International_Civic, y = Correlation)) + 
  geom_point(aes(color = Country)) +
  #geom_smooth(se = FALSE, color = "darkgrey", alpha = .5) +
  labs(y="Correlation", x = "Log International Civic Articles", color = "legend", title = "Figure 4: Total International Articles vs\nNational/International Correlation by Country") +
  theme_bw() +
