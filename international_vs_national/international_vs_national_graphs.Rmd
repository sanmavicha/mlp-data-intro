...
figure_1a <- ggplot(ghana_spike, aes(x = date, y = true_article_total)) +
  ...
  labs(x = "Date", y = "Article Totals", title = "Figure 2a: Ghana - True Spike") +
  theme_bw()
...
figure_1b <- ggplot(zambia_old, aes(x = date, y = total)) +
  ...
  labs(x = "Date", y = "Article Totals", title = "Figure 2b: Zambia - False Spike") +
  theme_bw()
...
figure_1 <- grid.arrange(figure_1a,
                      figure_1b,
                      nrow = 1,
                      top = textGrob("Figure 2: A True Spike and A False Spike",gp=gpar(fontsize=20,font=3)))
...
plot_indonesia <- grid.arrange(indonesia_corruption, indonesia_arrest, legend,
             ...
             top = textGrob("Figure 6: Indonesia 2024 Case Study",gp=gpar(fontsize=20,font=3)))
